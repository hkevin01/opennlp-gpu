...
print_next "Use: docs/apache/apache_proposal_email_final.md"
...
echo "# Send community proposal:"  echo "  Edit docs/apache/apache_proposal_email_final.md with your info"
...
echo ""
echo -e "${YELLOW}Start with:${NC} docs/apache/apache_contribution_summary.md"
