...
public class GpuNamedEntityRecognition {
    ...
    private Map<String, EntityType> initializeEntityDictionary() {
        ...
        String[] organizations = {
            ...
            "IBM", "Oracle", "Intel", "ESA", "FBI", "CIA", "NATO", "UN"
        };
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            String[] allSampleDocuments = {
                ...
                "ESA's Mars mission launched from the Guiana Space Centre in French Guiana. The mission is scheduled to arrive at Mars in 2025.",
